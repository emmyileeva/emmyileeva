<h1 align="left">Hi there! 🌸 My name is Emiliya Ileeva ✨</h1>
...
A collection of console-based and full-stack Java applications focused on real-world functionality.  
Currently includes a personal finance ledger, a customizable sandwich shop app (*Nom Nom Deli*), and a full-featured e-commerce platform (*EasyShop*).

📊 *Skills:* OOP, file I/O, data formatting, user interaction logic, input validation, clean code design, REST APIs, Spring Boot, JWT authentication, SQL Server, and frontend integration with HTML/CSS/JavaScript.
